  ...
  return (
    <footer className="bg-slate-800 pt-16 pb-8 overflow-hidden relative border-t border-blue-800/30">
        ...
        <div className="container mx-auto px-6 lg:px-12">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 mb-16">
                ...
                <div className="lg:col-span-4 space-y-6">
                    ...
                    <p className="text-slate-300 text-sm leading-relaxed max-w-sm">
                        Experience the future of event management. We bring people together through seamless technology and unforgettable experiences.
                    </p>
                 ...
                 <div className="lg:col-span-3 mx-auto">
                    ...
                    <ul className="space-y-4">
                        <li className="flex items-start gap-3 group">
                             ...
                             <span className="text-slate-300 text-sm leading-tight pt-1">123 Event Horizon Blvd, <br />Tech City, TC 90210</span>
                        </li>
                        <li className="flex items-center gap-3 group">
                             <div className="w-8 h-8 rounded-full bg-blue-900/50 flex items-center justify-center text-accent shrink-0 group-hover:bg-accent group-hover:text-white transition-colors duration-300">
                                <Phone size={16} />
                             </div>
                             <span className="text-slate-300 text-sm group-hover:text-white transition-colors">+1 (555) 123-4567</span>
                        </li>
                        <li className="flex items-center gap-3 group">
                             <div className="w-8 h-8 rounded-full bg-blue-900/50 flex items-center justify-center text-accent shrink-0 group-hover:bg-accent group-hover:text-white transition-colors duration-300">
                                <Mail size={16} />
                             </div>
                             <span className="text-slate-300 text-sm group-hover:text-white transition-colors">hello@eventhubpro.com</span>
                        </li>
                    </ul>
                </div>
            ...
            {/* Divider */}
            <div className="h-px w-full bg-gradient-to-r from-transparent via-blue-800 to-transparent my-8 opacity-50"></div>

            {/* Bottom Footer */}
            <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-slate-400">
                <p>&copy; {new Date().getFullYear()} EventHub Pro. All rights reserved.</p>
