...
const TierCard = ({ tier }) => {
  return (
    <div
      tabIndex={0}
      className="shadow-lg border-2 border-neutral-200 flex flex-col items-center gap-3.5 rounded-lg py-6 h-100 focus:ring focus:ring-accent"
    >
      <h1 className="text-primary text-xl font-bold">{tier.title}</h1>
      <h2 className="text-primary text-4xl font-bold">${tier.reducedPrice}</h2>
